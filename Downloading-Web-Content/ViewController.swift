...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url  = NSURL(string: "https://www.iplocation.net/find-ip-address")!
        
        webView.loadRequest(NSURLRequest(URL: url))
        //TO SIMPLY DOWNLOAD WEB CONTENT AND DISPLAY IT DIRECTLY IN THE WEBVIEW, USE THE ^^ CODE ABOVE
        
        //TO DOWNLOAD WEB CONTENT AND USE IT FOR SOMETHING ELSE, USE THE FOLLOWING:
